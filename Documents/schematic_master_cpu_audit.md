...
| `7A`, `7C`, `7D`, `8A`, `8B`, `8D`, `8E`, `9C`, `9D`, `10C`, `10D` gates/latches/counter | `74LS14`, `74LS74`, `74LS00`, `74LS393`, `74LS32`, `74LS08`, `74LS00`, `74LS74`, `74LS02`, `74LS20`, `74LS00` | `FREQ`, `PACMRAM`, `BDEL2H`, `BWRITE`, `PABR/W`, `MORAM`, reset/watchdog nets | Timing, reset, write, and select glue | scattered simple enables | `MISSING/PARTIAL` | IC inventory/type pass now matches the readable Sheet 2A PDF render; needs focused gate-level pin trace before exact timing changes. |
...
| `1P`, `1R`, `8C` interconnect block | `74LS244`, `74LS04` plus resistor packs | `B5M`, `B5M*`, `B1H`, `B2H`, `B4H`, `B8H`, `B16H`, `B32H`, `B256H`, `BVBLANK`, `BMAP*` | Master/slave timing and interconnect nets | mostly implicit counters and direct bitmap signals | `MISSING/PARTIAL` | Manual review now separates the LS244 buffers and corrects the 5 MHz nomenclature: upper `1P` distributes `E1H/E2H/E4H/E8H` to `B1H/B2H/B4H/B8H`; lower `1R` distributes `MAP0/MAP1/MAP2/E32H/E5M` and related rails to `BMAP0/BMAP1/BMAP2/B32H/B5M*/B5M`. Nearby `8C` inverters/buffers are involved in the `B5M*`/`B5M` complement/export path. These timing nets affect video/motion/bitmap; upstream `E5M` source remains to be audited before final 1:1 timing. |

`VERIFY` 2026-07-05: The Sheet 2A visual-check table now separates the
previous collapsed CPU/glue entry into individual inventory rows for `7A`,
`7C`, `7D`, `7E`, `8A`, `8B`, `8D`, `8E`, `9C`, `9D`, `10C`, and `10D`, plus
the full `3C` 6502B pin checklist. A review against
`Documents/Master/Sheet2A.pdf` corrected the local types: `7C=74LS74`,
`7D=74LS00`, `8A=74LS393`, `9C=74LS74`, `9D=74LS02`, and added visible
packages `7A`, `8E`, and `10D`. These rows remain `Check` because the next
step is package-by-package pin tracing. The current Verilog can still run
because this area is largely implemented as functional CPU, address decode,
memory-map, reset, and IRQ logic rather than a gate-for-gate representation of
every Sheet 2A package.
